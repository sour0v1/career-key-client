...
const Banner = () => {
    return (
        <div style={{ backgroundImage: `url(${banner})` }} className="bg-cover bg-center w-full h-[400px] lg:h-[600px]">
            <div className='bg-black bg-opacity-70 h-full text-white flex flex-col justify-center items-center'>
                <div className='flex flex-col justify-center items-center lg:items-start gap-6'>
                    <h2 className='text-4xl lg:text-6xl font-bold text-center w-3/4 lg:w-auto'>Find Talent, Find Jobs</h2>
                    <h2 className='text-xl lg:text-2xl font-bold text-center'>A Platform Built for Success in Every Search</h2>
